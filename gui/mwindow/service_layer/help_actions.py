...
def create_help_actions() -> (any, any):
    """Function to create the help action in the menu bar."""
    open_web = create_action("Open CR Web", icon="", checkable=False, slot=_open_cr_web,
                                       tip="Open CommonRoad Website", shortcut=None)
    open_forum = create_action("Open Forum", icon="", checkable=False, slot=_open_cr_forum,
