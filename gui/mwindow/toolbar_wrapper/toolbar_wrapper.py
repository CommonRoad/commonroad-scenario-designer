...
class ToolBarWrapper:
    ...
    def __init__(self, mwindow, file_new, open_commonroad_file, file_save):
        ...
        self.action_save.triggered.connect(file_save)
        ...
        self.action_road_network_toolbox.triggered.connect(_road_network_toolbox_show)
        ...
        self.action_obstacle_toolbox.triggered.connect(_obstacle_toolbox_show)
        ...
        self.action_converter_toolbox.triggered.connect(_map_converter_toolbox_show)
        ...
        self.button_play_pause.triggered.connect(play_pause_animation)
        ...
        self.slider.valueChanged.connect(_time_step_change)
        self.slider.sliderPressed.connect(_detect_slider_clicked)
        self.slider.sliderReleased.connect(_detect_slider_release)
