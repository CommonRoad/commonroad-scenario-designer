...
class TestParser(unittest.TestCase):
    ...
    def test_parse_opendrive_road_lane_offset(self):
        file_path = (
            os.path.dirname(os.path.abspath(__file__)) + "/../../test_maps/opendrive/CrossingComplex8Course.xodr"
        )
        with open("{}".format(file_path), "r") as file_in:
            root = etree.parse(file_in).getroot()
        road_xml = []
    ...
    def test_lane_access(self):
        file_path = (
            os.path.dirname(os.path.abspath(__file__)) + "/../../test_maps/opendrive/straight_road_lane_access.xodr"
        )
    ...
    def test_default_vals(self):
        ...
        """
        file_path = os.path.dirname(os.path.abspath(__file__)) + "/../../test_maps/opendrive/straight_road_default.xodr"
        with open("{}".format(file_path), "r") as file_in:
            root = etree.parse(file_in).getroot()
