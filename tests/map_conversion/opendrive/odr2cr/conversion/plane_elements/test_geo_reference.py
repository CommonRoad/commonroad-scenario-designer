...
class TestGeoReference(unittest.TestCase):
    def test_get_geo_reference(self):
        test1 = (
            "+proj=tmerc +a=6378137 +b=6378137 +lon_0=8.4256947318197106 +x_0=-0 +y_0=-5453802.4935722183 +k=1.0 "
        ...
        test2 = (
            "+proj=lcc +lat_1=48.66666666666666 +lat_2=53.66666666666666 +lat_0=51 +lon_0=10.5 +x_0=0 +y_0=0 "
        ...
        test3 = (
            "+proj=lcc +lat_1=48.66666666666666 +lat_2=53.66666666666666 +x_0=0 +y_0=0 "
            "+ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs"
        )
