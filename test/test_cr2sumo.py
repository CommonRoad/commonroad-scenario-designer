...
class TestConversionComplexIntersection(BaseClass):
...
class TestConversionGarching(BaseClass):
...
class TestConversionIntersectAndCrossing(BaseClass):
...
class TestConversionMergingLanelets(BaseClass):
...
class TestConversionUrban1(BaseClass):
...
class TestSimulationAAH1(BaseClass):
    __test__ = False
    cr_file_name = "DEU_AAH-1_8007_T-1"
    tls_lanelet_ids = [154]


class TestSimulationAAH2(BaseClass):
...
class TestDEU_Guetersloh(BaseClass):
    __test__ = True
    cr_file_name = "DEU_Guetersloh-20_4_T-1"


class TestDEU_Muc(BaseClass):
    __test__ = True
    cr_file_name = "DEU_Muc-13_1_T-1"

class TestUSA_Lanker(BaseClass):
    __test__ = True
    cr_file_name = "USA_Lanker-2_13_T-1"
