...
from commonroad.scenario.lanelet import LineMarking, RoadUser, LaneletType

from crdesigner.ui.gui.utilities.toolbox_ui import PositionButton, CollapsibleCheckBox, CollapsibleArrowBox, \
    CheckableComboBox
...
class LaneletAttributesWidget():
    ...
    def add_attribute_fields(self):
        ...
        self.toolbox.selected_lanelet_start_position_x.setAlignment(Qt.AlignRight)
        ...
        self.toolbox.selected_lanelet_start_position_y.setAlignment(Qt.AlignRight)
        self.toolbox.selected_button_start_position = PositionButton(self.toolbox.selected_lanelet_start_position_x, self.toolbox.selected_lanelet_start_position_y, self.toolbox)
        ...
        self.toolbox.selected_lanelet_start_position.addWidget(self.toolbox.selected_lanelet_start_position_x, 1, 1)
        ...
        self.toolbox.selected_lanelet_start_position.addWidget(self.toolbox.selected_lanelet_start_position_y, 1, 4)
        self.toolbox.selected_lanelet_start_position.addWidget(QLabel("[m]"), 1, 5)
        self.toolbox.selected_lanelet_start_position.addWidget(self.toolbox.selected_button_start_position, 1, 6)
        ...
        self.toolbox.selected_lanelet_end_position_x.setAlignment(Qt.AlignRight)
        ...
        self.toolbox.selected_lanelet_end_position_y.setAlignment(Qt.AlignRight)
        self.toolbox.selected_button_end_position = PositionButton(self.toolbox.selected_lanelet_end_position_x, self.toolbox.selected_lanelet_end_position_y, self.toolbox)
        self.toolbox.selected_lanelet_end_position = QGridLayout()
        self.toolbox.selected_lanelet_end_position.addWidget(QLabel("x: "), 1, 0)
        self.toolbox.selected_lanelet_end_position.addWidget(self.toolbox.selected_lanelet_end_position_x, 1, 1)
        ...
        self.toolbox.selected_lanelet_end_position.addWidget(self.toolbox.selected_lanelet_end_position_y, 1, 4)
        self.toolbox.selected_lanelet_end_position.addWidget(QLabel("[m]"), 1, 5)
        self.toolbox.selected_lanelet_end_position.addWidget(self.toolbox.selected_button_end_position, 1, 6)

        self.toolbox.selected_end_position_x_changed = False
        self.toolbox.selected_end_position_y_changed = False
        self.toolbox.selected_lanelet_end_position_x.textChanged.connect(self.update_selected_length)
        self.toolbox.selected_lanelet_end_position_y.textChanged.connect(self.update_selected_length)
        self.toolbox.selected_lanelet_start_position_x.textChanged.connect(self.update_selected_length)
        self.toolbox.selected_lanelet_start_position_y.textChanged.connect(self.update_selected_length)
        ...
        self.toolbox.selected_lanelet_length.setAlignment(Qt.AlignRight)
        ...
        self.toolbox.selected_lanelet_width.setAlignment(Qt.AlignRight)
        ...
        self.toolbox.selected_lanelet_radius.setAlignment(Qt.AlignRight)

        self.toolbox.selected_lanelet_angle = QLineEdit()
        self.toolbox.selected_lanelet_angle.setMaxLength(6)
        self.toolbox.selected_lanelet_angle.setAlignment(Qt.AlignRight)
    ...
    def add_selected_line_markings(self, layout_attributes):
        ...
        self.toolbox.connecting_radio_button_group_selected_stop_line.addButton(self.toolbox.selected_stop_line_beginning)
        self.toolbox.selected_stop_line_beginning.setChecked(True)
        self.toolbox.selected_stop_line_beginning.clicked.connect(lambda: self.adjust_selected_stop_line_position())

        self.toolbox.selected_stop_line_end = QRadioButton("end")
        self.toolbox.connecting_radio_button_group_selected_stop_line.addButton(self.toolbox.selected_stop_line_end)
        self.toolbox.selected_stop_line_end.clicked.connect(lambda: self.adjust_selected_stop_line_position())

        self.toolbox.selected_stop_line_select_position = QRadioButton("select pos")
        self.toolbox.connecting_radio_button_group_selected_stop_line.addButton(self.toolbox.selected_stop_line_select_position)
        self.toolbox.selected_stop_line_select_position.clicked.connect(lambda: self.adjust_selected_stop_line_position())
        ...
        self.toolbox.selected_stop_line_position.addWidget(self.toolbox.selected_stop_line_beginning, 1, 0)
        self.toolbox.selected_stop_line_position.addWidget(self.toolbox.selected_stop_line_end, 1, 1)
        self.toolbox.selected_stop_line_position.addWidget(self.toolbox.selected_stop_line_select_position, 1, 2)
        self.toolbox.selected_stop_line_select_position_checked_before = False

        self.toolbox.layout_stop_line.addRow("Line marking", self.toolbox.selected_line_marking_stop_line)
        self.toolbox.layout_stop_line.addRow(self.toolbox.selected_stop_line_position)

        self.toolbox.selected_stop_line_box = CollapsibleCheckBox("Stop Line", self.toolbox.layout_stop_line, layout_line_marking, 3)

        self.toolbox.line_marking_box = CollapsibleArrowBox("Line marking", layout_line_marking, layout_attributes, 6, self.toolbox.mwindow, self.toolbox)

    def adjust_selected_stop_line_position(self):
        if self.toolbox.selected_stop_line_select_position_checked_before:
            self.toolbox.layout_stop_line.removeRow(self.toolbox.selected_lanelet_select_stop_line_position)
        ...
        if self.toolbox.selected_stop_line_select_position.isChecked():
            ...
            self.toolbox.selected_stop_line_start_x.setAlignment(Qt.AlignRight)
            ...
            self.toolbox.selected_stop_line_start_y.setAlignment(Qt.AlignRight)
            ...
            self.toolbox.selected_stop_line_end_x.setAlignment(Qt.AlignRight)
            ...
            self.toolbox.selected_stop_line_end_y.setAlignment(Qt.AlignRight)

            self.toolbox.button_selected_stop_line_start_position = PositionButton(
                self.toolbox.selected_stop_line_start_x, self.toolbox.selected_stop_line_start_y, self.toolbox)
            self.toolbox.button_selected_stop_line_end_position = PositionButton(self.toolbox.selected_stop_line_end_x,
            ...
            self.toolbox.selected_lanelet_select_stop_line_position.addWidget(self.toolbox.selected_stop_line_start_x,
                                                                              1, 2)
            ...
            self.toolbox.selected_lanelet_select_stop_line_position.addWidget(self.toolbox.selected_stop_line_start_y,
                                                                              1, 5)
            ...
            self.toolbox.selected_lanelet_select_stop_line_position.addWidget(self.toolbox.selected_stop_line_end_x, 2,
                                                                              2)
            ...
            self.toolbox.selected_lanelet_select_stop_line_position.addWidget(self.toolbox.selected_stop_line_end_y, 2,
                                                                              5)
            ...
            self.toolbox.layout_stop_line.addRow(self.toolbox.selected_lanelet_select_stop_line_position)
    ...
    def add_selected_neighboring_fields(self, layout_attributes):
        ...
        self.toolbox.selected_adjacent_right_direction.addButton(self.toolbox.selected_adjacent_right_same_direction)
        ...
        self.toolbox.selected_adjacent_right_direction.addButton(self.toolbox.selected_adjacent_right_opposite_direction)

        self.toolbox.selected_adjacent_right_direction_line = QGridLayout()
        self.toolbox.selected_adjacent_right_direction_line.addWidget(self.toolbox.selected_adjacent_right_same_direction, 1, 0)
        self.toolbox.selected_adjacent_right_direction_line.addWidget(self.toolbox.selected_adjacent_right_opposite_direction, 1, 1)
        ...
        self.toolbox.selected_adjacent_left_direction.addButton(self.toolbox.selected_adjacent_left_same_direction)
        ...
        self.toolbox.selected_adjacent_left_direction.addButton(self.toolbox.selected_adjacent_left_opposite_direction)

        self.toolbox.selected_adjacent_left_direction_line = QGridLayout()
        self.toolbox.selected_adjacent_left_direction_line.addWidget(self.toolbox.selected_adjacent_left_same_direction, 1, 0)
        self.toolbox.selected_adjacent_left_direction_line.addWidget(self.toolbox.selected_adjacent_left_opposite_direction, 1, 1)
        ...
        self.toolbox.selected_neighboring_lanelets_button = CollapsibleArrowBox("Neighboring Lanelets", layout_neighboring_lanelets,
                                                                        layout_attributes, 8, self.toolbox.mwindow, self.toolbox)
    ...
    def add_selected_advanced_fields(self, layout_attributes):
        ...
        layout_advanced.addRow("Users Bidirectional:", self.toolbox.selected_road_user_bidirectional)
        layout_advanced.addRow("Traffic Sign IDs:", self.toolbox.selected_lanelet_referenced_traffic_sign_ids)
        layout_advanced.addRow("Traffic Light IDs:", self.toolbox.selected_lanelet_referenced_traffic_light_ids)

        self.toolbox.advanced_button = CollapsibleArrowBox("Advanced", layout_advanced, layout_attributes, 10,
                                                           self.toolbox.mwindow, self.toolbox)
    ...
    def update_selected_length(self):
        ...
        if self.toolbox.selected_end_position_y_changed:
            self.toolbox.selected_end_position_y_changed = False
            return
        pos = [self.toolbox.selected_lanelet_start_position_x.text(),
    ...
    def update_selected_end_position(self):
        ...
        pos = [self.toolbox.selected_lanelet_start_position_x.text(),
               self.toolbox.selected_lanelet_start_position_y.text(),
               self.toolbox.selected_lanelet_end_position_x.text(), self.toolbox.selected_lanelet_end_position_y.text()]
        if any("" == v for v in pos) or any("-" == v for v in pos):
            return
