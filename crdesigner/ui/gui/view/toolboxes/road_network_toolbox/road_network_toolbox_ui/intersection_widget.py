...
class IntersectionsWidget:
    ...
    def create_intersection_widget(self):
        ...
        self.toolbox.button_start_position = PositionButton(
            self.toolbox.intersection_start_position_x,
            self.toolbox.intersection_start_position_y,
            self.toolbox,
        )
        ...
        self.toolbox.intersection_outgoings_table.setHorizontalHeaderLabels(
            ["ID", "Lanelets", "Inc. Group"]
        )
        ...
        self.toolbox.intersection_start_position.addWidget(
            self.toolbox.intersection_start_position_x, 1, 1
        )
        ...
        self.toolbox.intersection_start_position.addWidget(
            self.toolbox.intersection_start_position_y, 1, 4
        )
        ...
        intersection_outgoing_layout.addRow(
            self.toolbox.button_add_outgoing, self.toolbox.button_remove_outgoing
        )
        ...
        intersection_crossing_layout.addRow(
            self.toolbox.button_add_crossing, self.toolbox.button_remove_crossing
        )
