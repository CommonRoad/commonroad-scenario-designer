...
class AddIntersectionUI:
    ...
    def update_intersection_information(self):
        ...
        if self.road_network_toolbox_ui.selected_intersection.currentText() not in ["", "None"]:
            ...
            for incoming in intersection.incomings:
                ...
                self.road_network_toolbox_ui.intersection_incomings_table.cellWidget(
                    num_rows - 1, 2
                ).set_checked_items([str(la_id) for la_id in incoming.outgoing_left])
                self.road_network_toolbox_ui.intersection_incomings_table.cellWidget(
                    num_rows - 1, 3
                ).set_checked_items([str(la_id) for la_id in incoming.outgoing_straight])
                self.road_network_toolbox_ui.intersection_incomings_table.cellWidget(
                    num_rows - 1, 4
                ).set_checked_items([str(la_id) for la_id in incoming.outgoing_right])
            ...
            for outgoing in intersection.outgoings:
                ...
                self.road_network_toolbox_ui.intersection_outgoings_table.cellWidget(
                    num_rows - 1, 1
                ).set_checked_items([str(la_id) for la_id in outgoing.outgoing_lanelets])
                self.road_network_toolbox_ui.intersection_outgoings_table.cellWidget(
                    num_rows - 1, 2
                ).set_checked_items(str(outgoing.incoming_group_id))
            ...
            for crossing in intersection.crossings:
                ...
                self.road_network_toolbox_ui.intersection_crossings_table.cellWidget(
                    num_rows - 1, 1
                ).set_checked_items([str(la_id) for la_id in crossing.crossing_lanelets])
                self.road_network_toolbox_ui.intersection_crossings_table.cellWidget(
                    num_rows - 1, 2
                ).set_checked_items([str(inc_id) for inc_id in crossing.incoming_group_id])
                self.road_network_toolbox_ui.intersection_crossings_table.cellWidget(
                    num_rows - 1, 3
                ).set_checked_items([str(inc_id) for inc_id in crossing.outgoing_group_id])
    ...
    def add_outgoing_to_table(self, new_outgoing: bool = True):
        ...
        combo_box_lanelets = CheckableComboBox()
        combo_box_lanelets.addItems(lanelet_ids)
        self.road_network_toolbox_ui.intersection_outgoings_table.setCellWidget(
            num_rows, 1, combo_box_lanelets
        )
        ...
        self.road_network_toolbox_ui.intersection_outgoings_table.setCellWidget(
            num_rows, 2, combo_box_incoming_group
        )
    ...
    def add_crossing_to_table(self, new_crossing: bool = True):
        ...
        combo_box_lanelets = CheckableComboBox()
        combo_box_lanelets.addItems(lanelet_ids)
        self.road_network_toolbox_ui.intersection_crossings_table.setCellWidget(
            num_rows, 1, combo_box_lanelets
        )
        ...
        self.road_network_toolbox_ui.intersection_crossings_table.setCellWidget(
            num_rows, 3, combo_box_outgoing_group
        )
