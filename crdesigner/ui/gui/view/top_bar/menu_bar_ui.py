...
class MenuBarUI:
    ...
    def __init__(self, mwindow):
        ...
        # add menu 'Setting'
        self.settings_action = self.create_action(text="Settings", icon="", checkable=False,
        ...
        self.open_web_action = self.create_action(text="Open CR Web", icon="", checkable=False, slot=open_cr_web,
                                                  tip="Open CommonRoad Website", shortcut=None)
        self.menu_help.addAction(self.open_web_action)
        self.open_forum_action = self.create_action(text="Open Forum", icon="", checkable=False, slot=open_cr_forum,
