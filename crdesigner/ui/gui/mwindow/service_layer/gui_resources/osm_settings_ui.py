...
class Ui_OSMSettings():
    ...
    def setupUi(self, tabWidget):
        ...
        self.label_timestep_size.setMinimumSize(self.widthf, 20)
        ...
        self.sb_timestep_size.setMinimumSize(self.widthm, 20)
        ...
        self.label_load_tunnels.setMinimumSize(self.widthf, 20)
        ...
        self.label_make_contiguous.setMinimumSize(self.widthf, 20)
        ...
        self.label_split_corners.setMinimumSize(self.widthf, 20)
        ...
        self.label_osm_restrictions.setMinimumSize(self.widthf, 20)
        ...
        self.label_conv_street_types.setMinimumSize(self.widthf, 20)
        ...
        self.btn_edit_street_types.setMinimumSize(self.widthm, 20)
        ...
        self.btn_edit_lane_counts.setMinimumSize(self.widthm, 20)
        self.label_lane_counts = QtWidgets.QLabel(self.content[column])
        self.label_lane_counts.setObjectName("label_24")
        self.label_lane_counts.setMinimumSize(self.widthf, 20)
        ...
        self.label_lane_width.setMinimumSize(self.widthf, 20)
        ...
        self.btn_edit_lane_widths.setMinimumSize(self.widthm, 20)
        ...
        self.btn_edit_speed_limits.setMinimumSize(self.widthm, 20)
        self.label_speed_limits = QtWidgets.QLabel(self.content[column])
        self.label_speed_limits.setObjectName("label_26")
        self.label_speed_limits.setMinimumSize(self.widthf, 20)
        ...
        self.label_interpolation_distance.setMinimumSize(self.widthf, 20)
        ...
        self.sb_interpolation_distance.setMinimumSize(self.widthm, 20)
        ...
        self.sb_compression_threshold.setMinimumSize(self.widthm, 20)
        ...
        self.label_compression_threshold.setMinimumSize(self.widthf, 20)
        ...
        self.label_utm_coordinates.setMinimumSize(self.widthf, 20)
        ...
        self.label_filter_points.setMinimumSize(self.widthf, 20)
        ...
        self.label_earth_radius.setMinimumSize(self.widthf, 20)
        ...
        self.sb_earth_radius.setMinimumSize(self.widthm, 20)
        ...
        self.label_delete_short_edge.setMinimumSize(self.widthf, 20)
        ...
        self.label_internal_interpol_dist.setMinimumSize(self.widthf, 20)
        ...
        self.sb_internal_interpolation_distance.setMinimumSize(self.widthm, 20)
        ...
        self.sb_bezier_parameter.setMinimumSize(self.widthm, 20)
        self.label_bezier_param = QtWidgets.QLabel(self.content[column])
        self.label_bezier_param.setObjectName("label_34")
        self.label_bezier_param.setMinimumSize(self.widthf, 20)
        ...
        self.label_intersec_dist.setMinimumSize(self.widthf, 20)
        ...
        self.sb_intersection_distance.setMinimumSize(self.widthm, 20)
        ...
        self.label_intersection_distance_respect.setMinimumSize(self.widthf, 20)
        ...
        self.sb_soft_angle_treshold.setMinimumSize(self.widthm, 20)
        ...
        self.label_soft_angle_threshold.setMinimumSize(self.widthf, 20)
        ...
        self.label_lane_segment_angle_treshold.setMinimumSize(self.widthf, 20)
        ...
        self.sb_lane_segment_angle_treshold.setMinimumSize(self.widthm, 20)
        ...
        self.label_cluster_length_treshold.setMinimumSize(self.widthf, 20)
        ...
        self.sb_cluster_length_treshold.setMinimumSize(self.widthm, 20)
        ...
        self.label_extract_sublayer.setMinimumSize(self.widthf, 20)
        ...
        self.label_sublayer_way_types.setMinimumSize(self.widthf, 20)
        ...
        self.btn_edit_sublayer_way_types.setMinimumSize(self.widthm, 20)
        ...
        self.label_intersection_distance_sublayer.setMinimumSize(self.widthf, 20)
        ...
        self.sb_intersection_distance_sublayer.setMinimumSize(self.widthm, 20)
