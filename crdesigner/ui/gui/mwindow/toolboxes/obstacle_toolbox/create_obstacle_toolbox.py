...
def create_obstacle_toolbox(mwindow):
    ...
    mwindow.obstacle_toolbox = ObstacleToolbox(current_scenario = mwindow.animated_viewer_wrapper.cr_viewer.current_scenario,
                                               callback = lambda scenario: toolbox_callback(mwindow, scenario),tmp_folder = mwindow.tmp_folder, text_browser = mwindow.crdesigner_console_wrapper.text_browser)
