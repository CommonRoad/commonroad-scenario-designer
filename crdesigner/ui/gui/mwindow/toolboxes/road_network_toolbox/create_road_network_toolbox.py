...
def create_road_network_toolbox(mwindow):
    ...
    mwindow.road_network_toolbox = RoadNetworkToolbox(current_scenario=mwindow.animated_viewer_wrapper.cr_viewer.current_scenario,
                                                      text_browser=mwindow.crdesigner_console_wrapper.text_browser, callback= lambda scenario: toolbox_callback(mwindow, scenario),
                                                      tmp_folder=mwindow.tmp_folder,
                                                      selection_changed_callback=mwindow.animated_viewer_wrapper.cr_viewer.update_plot)
