...
def resize_scenario_based_on_zoom(original_lanelet_network: LaneletNetwork, center_x: float, center_y: float, dim_x: float, dim_y: float) -> LaneletNetwork:
    ...
    if detailed_drawing_params_threshold_zoom_met(x=dim_x, y=dim_y) and is_big_map(
        ...
        return original_lanelet_network
