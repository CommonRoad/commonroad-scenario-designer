...
class AddTrafficSignController:
    ...
    def add_traffic_sign(self, traffic_sign_id: int = None):
        ...
        if self.road_network_toolbox_ui.x_position_traffic_sign.text():
            x_position = self.road_network_controller.get_float(self.road_network_toolbox_ui.x_position_traffic_sign)
        else:
            x_position = 0
        if self.road_network_toolbox_ui.y_position_traffic_sign.text():
            y_position = self.road_network_controller.get_float(self.road_network_toolbox_ui.y_position_traffic_sign)
        else:
            y_position = 0
