...
class TestConverterConvert(unittest.TestCase):
    ...
    def prepareConversion(self, map_name):
        ...
        self.file_path_in = f"maps/commonroad/{self.map_name}.xml"

        # relative path for input
        self.file_path_out = f"test_maps/{self.map_name}.xodr"
    ...
    def test_convert_USA_Lanker(self):
        ...
        self.checkWithGroundTruth(f"reference_maps/{self.map_name}.xodr")
