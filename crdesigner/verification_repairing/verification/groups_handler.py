...
from crdesigner.verification_repairing.verification.formula_ids import \
    FormulaID, LaneletFormulaID, TrafficSignFormulaID, TrafficLightFormulaID, IntersectionFormulaID, GeneralFormulaID
...
class GroupsHandler:
    ...
    groups: List[SpecificationGroup] = \
        dataclasses.field(default_factory=lambda: [
            SpecificationGroup(
                    priority=0,
                    formulas=[LaneletFormulaID.LEFT_RIGHT_BOUNDARY_ASSIGNMENT, GeneralFormulaID.UNIQUE_ID]),
            SpecificationGroup(
                priority=1,
                formulas=[LaneletFormulaID.POLYLINES_INTERSECTION,
                          LaneletFormulaID.LEFT_SELF_INTERSECTION,
                          LaneletFormulaID.RIGHT_SELF_INTERSECTION]
            ),
            SpecificationGroup(
                priority=2,
                formulas=[LaneletFormulaID.SAME_VERTICES_SIZE,
                          ...
                          LaneletFormulaID.STOP_LINE_REFERENCES, LaneletFormulaID.CONFLICTING_LANELET_DIRECTIONS]),
            SpecificationGroup(
                    priority=15,
                    formulas=[LaneletFormulaID.EXISTENCE_SUCCESSOR, LaneletFormulaID.EXISTENCE_PREDECESSOR,
                              LaneletFormulaID.EXISTENCE_LEFT_ADJ, LaneletFormulaID.EXISTENCE_RIGHT_ADJ,
                              LaneletFormulaID.POTENTIAL_SUCCESSOR, LaneletFormulaID.POTENTIAL_PREDECESSOR,
                              ...
                              LaneletFormulaID.POTENTIAL_LEFT_MERGING_ADJ, LaneletFormulaID.POTENTIAL_RIGHT_MERGING_ADJ,
            ...
            SpecificationGroup(
                    priority=20,
                    formulas=[LaneletFormulaID.CONNECTIONS_SUCCESSOR, LaneletFormulaID.CONNECTIONS_PREDECESSOR,
                              ...
                              TrafficLightFormulaID.NON_ZERO_DURATION, TrafficLightFormulaID.UNIQUE_STATE_IN_CYCLE,
