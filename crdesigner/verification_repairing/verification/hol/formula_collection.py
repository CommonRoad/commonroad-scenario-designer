...
class LaneletFormulas:
    formulas: Dict[str, str] = {'same_vertices_size': 'size(left_polyline(l)) = size(right_polyline(l)) || l in L',
...
class TrafficSignFormulas:
    formulas: Dict[str, str] = {'at_least_one_traffic_sign_element': 'size(traffic_sign_elements(t)) > 0 || t in TS',
...
class TrafficLightFormulas:
    formulas: Dict[str, str] = {'at_least_one_cycle_element': 'size(cycle_elements(t)) > 0 || t in TL',
