...
class OpenDriveConfig(BaseConfig):
    ...
    error_tolerance = Attribute(0.15, "Error tolerance",
                                "Max. error between reference geometry and polyline of vertices")

    min_delta_s = Attribute(0.5, "Min. delta s",
    ...
    driving_default_lanelet_type = Attribute("urban", "Driving default lanelet type",
                                             "Mapping of OpenDRIVE driveway lane type to a CommonRoad lanelet type")

    general_lanelet_type_activ = Attribute(True, "General lanelet type active",
                                           "Activates whether certain lanelet type should be added to all lanelets")

    general_lanelet_type = Attribute("urban", "General lanelet type",
                                     "Lanelet type which is added to every lanelet (if activated)")

    lanelet_types_backwards_compatible = Attribute(False, "Lanelet types backwards compatible",
    ...
    intersection_straight_threshold = Attribute(35.0, "Intersection straight threshold",
                                                "Threshold which is used to determine if a successor of an incoming "
                                                "lane is ")

    lane_segment_angle = Attribute(5.0, "Lane segment angle", "Least angle for lane segment to be added to the "
