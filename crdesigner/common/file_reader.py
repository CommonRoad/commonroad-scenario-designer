...
class CRDesignerFileReader(CommonRoadFileReader):
    ...
    def open_map(self, verify_repair_lanelet_network: bool = False) -> Tuple[LaneletNetwork, List[EnvironmentObstacle]]:
        """
    ...
    def open_map_dynamic(self, verify_repair_lanelet_network: bool = False) -> Scenario:
        """
    ...
    def open_all(
        self, verify_repair_lanelet_network: bool = False
