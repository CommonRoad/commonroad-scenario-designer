...
if __name__ == '__main__':
    ...
    transfer.transfer_yaml_to_config('crdesigner/configurations/custom_settings.yaml', config)
    from crdesigner.map_conversion.osm2cr import config
    transfer.transfer_yaml_to_config('crdesigner/configurations/custom_settings_osm2cr.yaml', config)
    start_gui_new()
