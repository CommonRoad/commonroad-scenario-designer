...
from crdesigner.io.scenario_designer.toolboxes.toolbox_ui import Toolbox, CheckableComboBox, QHLine
...
class RoadNetworkToolboxUI(Toolbox):
    ...
    def create_lanelet_operations_widget(self):
        ...
        lanelet_operations_information.addRow(self.create_adjacent_left_selection, self.create_adjacent_right_selection)
        lanelet_operations_information.addRow(self.create_adjacent_same_direction_selection)
        lanelet_operations_information.addRow(self.button_create_adjacent)
        lanelet_operations_information.addRow(self.button_attach_to_other_lanelet)
        lanelet_operations_information.addRow(self.button_connect_lanelets)
        lanelet_operations_information.addRow(self.button_merge_lanelets)
        layout_lanelet_operations.addLayout(lanelet_operations_information)
        ...
        layout_lanelet_operations.addLayout(lanelet_rotate_layout)
        ...
        layout_lanelet_operations.addLayout(lanelet_translate_layout)
