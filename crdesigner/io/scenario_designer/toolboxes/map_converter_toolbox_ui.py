...
class MapConversionToolboxUI(Toolbox):
    ...
    def create_sumo_widget(self):
        ...
        self.button_convert_to_sumo_to_commonroad = QPushButton("Convert SUMO to CommonRoad")
        self.button_convert_to_sumo = QPushButton("Convert CommonRoad to SUMO")
        ...
        layout_sumo.addWidget(self.button_convert_to_sumo)
        layout_sumo.addWidget(self.button_convert_to_sumo_to_commonroad)
    ...
    def create_lanelet_widget(self):
        ...
        self.button_convert_lanelet2 = QPushButton("Convert Lanelet/Lanelet2 to CommonRoad")
        self.button_convert_lanelet2_to_commonroad = QPushButton("Convert CommonRoad to Lanelet/Lanelet2")
        ...
        layout_lanelet2.addWidget(self.button_convert_lanelet2)
        layout_lanelet2.addWidget(self.button_convert_lanelet2_to_commonroad)
    ...
    def create_opendrive_widget(self):
        ...
        layout_opendrive.addWidget(self.button_convert_opendrive)
    ...
    def create_osm_widget(self):
        ...
        layout_local_file_selection_groupbox = QFormLayout()
        osm_file_selection_groupbox = QGroupBox()
        osm_file_selection_groupbox.setLayout(layout_local_file_selection_groupbox)
        layout_local_file_selection_groupbox.addRow(self.button_load_osm_edit_state)
        layout_local_file_selection_groupbox.addRow(self.button_load_osm_file)
        layout_osm_selection_groupbox.addWidget(osm_file_selection_groupbox)
        ...
        layout_osm_conversion_groupbox.addRow(self.osm_conversion_edit_manually_selection)
