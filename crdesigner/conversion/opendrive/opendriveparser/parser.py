...
from crdesigner.conversion.opendrive.opendriveparser.elements.roadLink import (
    Predecessor as RoadLinkPredecessor,
    Successor as RoadLinkSuccessor,
    Neighbor as RoadLinkNeighbor,
)
from crdesigner.conversion.opendrive.opendriveparser.elements.roadtype import (
    RoadType,
    Speed as RoadTypeSpeed,
)
from crdesigner.conversion.opendrive.opendriveparser.elements.roadElevationProfile import (
    ElevationRecord as RoadElevationProfile,
)
from crdesigner.conversion.opendrive.opendriveparser.elements.roadLateralProfile import (
...
from crdesigner.conversion.opendrive.opendriveparser.elements.roadLanes import (
...
from crdesigner.conversion.opendrive.opendriveparser.elements.junction import (
    Junction,
    Connection as JunctionConnection,
    LaneLink as JunctionConnectionLaneLink,
)
from crdesigner.conversion.opendrive.opendriveparser.elements.roadSignal import (
...
def parse_opendrive_road_signal(newRoad, road_signal):
    """

    :param newRoad: class Road
