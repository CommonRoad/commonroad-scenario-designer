...
from crdesigner.osm2cr.converter_modules.osm_operations.downloader import (
    download_around_map,
)
from crdesigner.io.scenario_designer.osm_gui_modules.gui_embedding import MainApp
