...
from crdesigner.osm2cr.converter_modules.utility import geometry, idgenerator, traffic_sign_parser
from crdesigner.osm2cr.converter_modules.utility.custom_types import (
    Road_info,
    Assumption_info,
)
import math
