...
from crdesigner.crmapver.verification.formula_ids import FormulaID, LaneletFormulaID, TrafficSignFormulaID, TrafficLightFormulaID,\
...
class GroupsHandler:
    ...
    groups: List[SpecificationGroup] = \
        dataclasses.field(default_factory=lambda: [
            SpecificationGroup(
                priority=0,
                formulas=[LaneletFormulaID.UNIQUE_ID, LaneletFormulaID.SAME_VERTICES_SIZE,
