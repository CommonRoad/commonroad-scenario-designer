...
from crdesigner.crmapver.map_verification_repairing import verify_and_repair_dir_maps, verify_and_repair_map
...
file = os.path.join(os.getcwd(), '../tests/map_verification/test_maps/DEU_BadEssen-3_1_T-1.xml')
