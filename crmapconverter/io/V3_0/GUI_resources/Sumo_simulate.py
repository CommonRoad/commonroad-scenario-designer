...
class Ui_sumo_simulate(object):
    def setupUi(self, sumo_simulate):
        ...
        self.label = QtWidgets.QLabel(sumo_simulate)
        self.label.setObjectName("label")
        self.gridLayout.addWidget(self.label, 0, 0, 1, 1)
        self.doubleSpinBox_dt = QtWidgets.QDoubleSpinBox(sumo_simulate)
        self.doubleSpinBox_dt.setObjectName("doubleSpinBox_dt")
        self.gridLayout.addWidget(self.doubleSpinBox_dt, 0, 1, 1, 1)
        self.label_2 = QtWidgets.QLabel(sumo_simulate)
        self.label_2.setObjectName("label_2")
        self.gridLayout.addWidget(self.label_2, 1, 0, 1, 1)
        self.spinBox_presimulation_steps = QtWidgets.QSpinBox(sumo_simulate)
        ...
        self.label_3 = QtWidgets.QLabel(sumo_simulate)
        self.label_3.setObjectName("label_3")
        self.gridLayout.addWidget(self.label_3, 2, 0, 1, 1)
        self.spinBox_simulation_steps = QtWidgets.QSpinBox(sumo_simulate)
        ...
        self.pushButton_simulate = QtWidgets.QPushButton(sumo_simulate)
        self.pushButton_simulate.setObjectName("pushButton_simulate")
        self.verticalLayout.addWidget(self.pushButton_simulate)
