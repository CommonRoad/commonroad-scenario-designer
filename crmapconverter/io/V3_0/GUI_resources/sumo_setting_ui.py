...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.sb = QtWidgets.QSpinBox(self.scrollAreaWidgetContents)
        self.sb.setLocale(QtCore.QLocale(QtCore.QLocale.English, QtCore.QLocale.UnitedStates))
        self.sb.setMaximum(99999)
        self.sb.setProperty("value", 3)
        ...
        self.sb_2 = QtWidgets.QSpinBox(self.scrollAreaWidgetContents)
        self.sb_2.setObjectName("spinBox_2")
        self.gridLayout_2.addWidget(self.sb_2, 2, 2, 1, 1)
