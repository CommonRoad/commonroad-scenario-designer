...
class MWindow(QMainWindow, Ui_mainWindow):
    ...
    def create_export_actions(self):
        ...
        #     checkable=False,
        #     slot=self.cr_2_osm,
        #     tip="Convert from CommonRoad to OSM",
        #     shortcut=None)
    ...
    def file_new(self):
        """TODO Function to create the action in the menu bar."""
        #new = QTextEdit()
    ...
    def update_to_new_scenario(self):
        ...
        assert self.crviewer is not None, "find a solution to let this always be not None"
