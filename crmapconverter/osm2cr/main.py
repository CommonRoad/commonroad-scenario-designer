...
from converter_modules.gui_modules.gui_embedding import MainApp
...
def download_and_convert():
    ...
    download_around_map(config.SAVE_PATH + config.BENCHMARK_ID + '_downloaded.osm', x, y, config.DOWNLOAD_EDGE_LENGTH)
...
def main():
    parser = argparse.ArgumentParser(description='download or open an OSM file and convert it to CR or use GUI')
