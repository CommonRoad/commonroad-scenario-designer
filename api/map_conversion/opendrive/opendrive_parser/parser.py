...
from api.map_conversion.opendrive.opendrive_parser.elements.opendrive import OpenDrive, Header
from api.map_conversion.opendrive.opendrive_parser.elements.road import Road
from api.map_conversion.opendrive.opendrive_parser.elements.roadLink import Predecessor as RoadLinkPredecessor, \
    Successor as RoadLinkSuccessor, Neighbor as RoadLinkNeighbor
from api.map_conversion.opendrive.opendrive_parser.elements.roadtype import RoadType, Speed as RoadTypeSpeed
from api.map_conversion.opendrive.opendrive_parser.elements.roadElevationProfile \
    import ElevationRecord as RoadElevationProfile
from api.map_conversion.opendrive.opendrive_parser.elements.roadLateralProfile \
...
from api.map_conversion.opendrive.opendrive_parser.elements.roadLanes import LaneOffset as RoadLanesLaneOffset, \
...
from api.map_conversion.opendrive.opendrive_parser.elements.junction import Junction, \
    Connection as JunctionConnection, LaneLink as JunctionConnectionLaneLink
from api.map_conversion.opendrive.opendrive_parser.elements.roadSignal import Signal as RoadSignal, \
    SignalReference
