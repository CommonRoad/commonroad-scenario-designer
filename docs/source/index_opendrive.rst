...
OpenDRIVE and OSM lanelet converter documentation
=================================================

**opendrive2lanelet** is a tool which allows you to convert a road network description from the
`OpenDRIVE format <http://www.opendrive.org/project.html>`_ to the `CommonRoad format <https://commonroad.in.tum.de/documentation/xml_format_doc/>`_ (Version 2018b).
