...
from old.crdesigner.map_conversion.common.utils import generate_unique_id
from old.crdesigner.map_conversion.opendrive.opendrive_conversion.conversion_lanelet import ConversionLanelet
from old.crdesigner.map_conversion.opendrive.opendrive_conversion.conversion_lanelet_network import \
    ConversionLaneletNetwork, convert_to_new_lanelet_id
from old.crdesigner.map_conversion.lanelet_lanelet2.lanelet2 import OSMLanelet, WayRelation, DEFAULT_PROJ_STRING, Node, \
    RightOfWayRelation
