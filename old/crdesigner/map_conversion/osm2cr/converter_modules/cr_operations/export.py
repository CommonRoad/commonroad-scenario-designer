...
from old.crdesigner.map_conversion.osm2cr.converter_modules.intermediate_operations.intermediate_format import \
    IntermediateFormat
from old.crdesigner.map_conversion.osm2cr.converter_modules.utility import geometry
from old.crdesigner.map_conversion.osm2cr.converter_modules.utility.idgenerator import get_id
from old.crdesigner.map_conversion.osm2cr.converter_modules.utility.geonamesID import get_geonamesID
from old.crdesigner.map_conversion.osm2cr.converter_modules.cr_operations.cleanup import sanitize
