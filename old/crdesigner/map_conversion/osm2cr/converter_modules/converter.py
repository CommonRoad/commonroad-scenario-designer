...
from old.crdesigner.input_output.gui.osm_gui_modules import gui
from old.crdesigner.map_conversion.osm2cr.converter_modules.osm_operations import osm_parser
from old.crdesigner.map_conversion.osm2cr.converter_modules.utility import plots
from old.crdesigner.map_conversion.osm2cr.converter_modules.graph_operations import (
    road_graph,
    intersection_merger,
    offsetter,
    segment_clusters,
