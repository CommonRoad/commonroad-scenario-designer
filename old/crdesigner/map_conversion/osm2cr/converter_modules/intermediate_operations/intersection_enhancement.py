...
from old.crdesigner.map_conversion.osm2cr.converter_modules.utility import idgenerator, geometry
from old.crdesigner.map_conversion.osm2cr.converter_modules.intermediate_operations.traffic_light_generator import \
