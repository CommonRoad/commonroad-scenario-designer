...
if SUMO_AVAILABLE:
    from old.crdesigner.map_conversion.sumo_map.config import SumoConfig
    from old.crdesigner.map_conversion.sumo_map.cr2sumo.converter import CR2SumoMapConverter
    from old.crdesigner.map_conversion.sumo_map.sumo2cr import convert_net_to_cr

from old.crdesigner.map_conversion.osm2cr.converter_modules.converter import GraphScenario
