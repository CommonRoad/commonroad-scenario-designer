...
from old.crdesigner.map_conversion.osm2cr.converter_modules.cr_operations import export as ex
from old.crdesigner.map_conversion.osm2cr.converter_modules.graph_operations import road_graph as rg
from old.crdesigner.input_output.gui.osm_gui_modules import gui, settings
from old.crdesigner.input_output.gui.osm_gui_modules.GUI_resources.edge_edit_embedding import Ui_EdgeEdit \
    as eeGUI_frame
from old.crdesigner.input_output.gui.osm_gui_modules.GUI_resources.lane_link_edit_embedding \
    import Ui_LaneLinkEdit as llGUI_frame
from old.crdesigner.input_output.gui.osm_gui_modules.GUI_resources.scenario_view \
    import Ui_MainWindow as scenarioView
from old.crdesigner.input_output.gui.osm_gui_modules.GUI_resources.start_window import Ui_MainWindow as startWindow
