...
from old.crdesigner.input_output.gui.gui_resources.scenario_saving_dialog_ui import ScenarioDialogUI

from commonroad.scenario.scenario import Scenario, Tag, TimeOfDay, Weather, \
    Underground
